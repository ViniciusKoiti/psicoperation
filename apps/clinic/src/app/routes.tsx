 ...
 * financeiras, tarefas, atalhos). `/financeiro` (PSI-037): núcleo
 * financeiro — mensalidades do mês agrupadas por situação, geração
 * idempotente a partir dos pacientes ativos, marcar como paga (com
