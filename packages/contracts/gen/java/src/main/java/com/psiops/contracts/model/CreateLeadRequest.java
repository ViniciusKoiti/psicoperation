...
@JsonTypeName("createLead_request")
...
public class CreateLeadRequest implements Serializable {
   ...
   */
  public CreateLeadRequest(String name, String whatsapp, String email) {
    this.name = name;
    this.whatsapp = whatsapp;
    this.email = email;
  }

  public CreateLeadRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateLeadRequest whatsapp(String whatsapp) {
    this.whatsapp = whatsapp;
    return this;
  }
  ...
  public CreateLeadRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateLeadRequest createLeadRequest = (CreateLeadRequest) o;
    return Objects.equals(this.name, createLeadRequest.name) &&
        Objects.equals(this.whatsapp, createLeadRequest.whatsapp) &&
        Objects.equals(this.email, createLeadRequest.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLeadRequest {\n");
