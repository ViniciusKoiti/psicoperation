...
// tests for RegisterUser400Response
void main() {
  // final instance = RegisterUser400Response();

  group('test RegisterUser400Response', () {
    ...
    // List<RegisterUser400ResponseAllOfViolationsInner> violations (default value: const [])
    test('to test the property `violations`', () async {
      // TODO
    });
