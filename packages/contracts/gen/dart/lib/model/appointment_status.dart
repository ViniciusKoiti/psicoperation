...
/// Situação da consulta na agenda.
class AppointmentStatus {
  ...
  static const agendada = AppointmentStatus._(r'agendada');
  static const realizada = AppointmentStatus._(r'realizada');
  static const cancelada = AppointmentStatus._(r'cancelada');
  static const remarcada = AppointmentStatus._(r'remarcada');
...
class AppointmentStatusTypeTransformer {
  ...
  AppointmentStatus? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'agendada': return AppointmentStatus.agendada;
        case r'realizada': return AppointmentStatus.realizada;
        case r'cancelada': return AppointmentStatus.cancelada;
        case r'remarcada': return AppointmentStatus.remarcada;
        default:
          if (!allowNull) {
