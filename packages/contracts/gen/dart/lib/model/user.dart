  ...
  static User? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'createdAt'), 'Required key "User[createdAt]" is missing from JSON.');
        assert(json[r'createdAt'] != null, 'Required key "User[createdAt]" has a null value in JSON.');
        return true;
      }());
