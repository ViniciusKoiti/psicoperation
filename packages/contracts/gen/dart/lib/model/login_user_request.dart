...
class LoginUserRequest {
  ...
  static LoginUserRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'email'), 'Required key "LoginUserRequest[email]" is missing from JSON.');
        assert(json[r'email'] != null, 'Required key "LoginUserRequest[email]" has a null value in JSON.');
        assert(json.containsKey(r'password'), 'Required key "LoginUserRequest[password]" is missing from JSON.');
        assert(json[r'password'] != null, 'Required key "LoginUserRequest[password]" has a null value in JSON.');
        return true;
      }());
